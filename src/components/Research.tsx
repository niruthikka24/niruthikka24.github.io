...
export function Research() {
  const researchAreas = [{
    ...
    topics: ["Currently collaborating with Shiwei (master's student researcher) under Prof. Wang Yong at Nanyang Technological University (NTU)", "Contributing to the emerging field of LLM debugging and interpretability (ongoing work)"]
  }];
